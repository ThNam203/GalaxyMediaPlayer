...
namespace GalaxyMediaPlayer.Databases.MusicPage
{
    internal class MusicPageDatabaseAccess
    {
        private static readonly string DATABASE_PATH = AppDomain.CurrentDomain.BaseDirectory + "Databases\\MusicPage\\Database.txt";
