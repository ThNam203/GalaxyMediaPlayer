...
{
    internal class VideoPageDatabaseAccess
    {
        private static readonly string DATABASE_PATH = AppDomain.CurrentDomain.BaseDirectory + "Databases\\VideoPage\\Database.txt";
