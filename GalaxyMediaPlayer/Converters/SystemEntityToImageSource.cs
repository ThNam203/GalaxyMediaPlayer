...
{
    public class SystemEntityToImageSource : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (model != null)
            {
                if (model.Type == EntityType.Folder) 
                    ...
                    else if (model.Type == EntityType.Image)
                    {
                        // for images media files
                        Image image = Image.FromFile(model.Path);
                    ...
                    else if (model.Type == EntityType.Video)
                    {
                        // for video files
                        ShellFile shellFile = ShellFile.FromFilePath(model.Path);
